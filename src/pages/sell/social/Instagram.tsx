        ...
        <Card className="mt-8">
          <CardHeader>
            <div className="flex items-center gap-3 mb-2">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[hsl(320,70%,50%)] via-[hsl(340,90%,55%)] to-[hsl(45,100%,55%)] flex items-center justify-center">
                <Instagram className="h-6 w-6 text-white" />
              </div>
              <div>
                <CardTitle className="text-2xl">{t('sell.social.instagram.title')}</CardTitle>
                <CardDescription>{t('sell.social.instagram.subtitle')}</CardDescription>
              </div>
            </div>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="username">{t('sell.social.instagram.username')}</Label>
                <Input
                  id="username"
