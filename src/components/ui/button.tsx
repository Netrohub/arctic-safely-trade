  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95 min-h-[44px]",
  {
    variants: {
      variant: {
        ...
        arctic: "bg-primary hover:bg-primary/90 text-primary-foreground border-0 shadow-glow hover:shadow-[0_0_40px_hsl(var(--primary)/0.5)]",
        "arctic-ghost": "bg-foreground/5 hover:bg-foreground/10 text-foreground border-border border",
        danger: "bg-destructive hover:bg-destructive/90 text-destructive-foreground border-0",
      },
      size: {
